...
* 속도: 200ms/스텝에서 시작해 먹을수록 88ms/스텝까지 빨라짐
...
측정값(yosys + ETRI050 LEF 실측 셀 크기, `syn/area_sweep.txt`):

| CELL_SH | 그리드 | MAXLEN | TEXT | 셀 수 | FF | 셀 면적 | 코어@60% |
|---|---|---|---|---|---|---|---|
| 1 | 64x32 | 48 | 1 | 4280 | 841 | 2.77 mm² | **4.62 mm²** |
| 1 | 64x32 | 32 | 1 | 3632 | 665 | 2.32 mm² | 3.86 mm² |
| 2 | 32x16 | 24 | 0 | 2789 | 513 | 1.78 mm² | 2.97 mm² |
| 3 | 16x8 | 16 | 0 | 2312 | 401 | 1.46 mm² | 2.43 mm² |

패드 프레임의 코어 창(직접 측정):

* `MPW_PAD_28Pin_IO` : 다이 약 1.9 x 1.9 mm, 코어 창 **약 1.0 mm²**
* `MPW_PAD_84Pin_IO` : 다이 약 3.8 x 3.8 mm, 코어 창 **약 8.4 mm²**

**어떤 파라미터 조합으로도 28핀 프레임에는 들어가지 않습니다.** 몸통 길이를
0으로 줄여도 I2C + 디스플레이 시퀀서 + 게임 FSM + 폰트만으로 약 1.5 mm²의
셀이 남기 때문입니다. 기본 설정(2x2 셀, MAXLEN 48)은 4.6 mm²로 84핀 프레임
안에서 여유가 있습니다. 자세한 모듈별 분해와 추가 최적화 여지는
`docs/area.md` 를 보세요.
