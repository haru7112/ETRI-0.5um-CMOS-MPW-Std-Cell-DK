...
if {[is_project_open]} {
	if {[string compare $quartus(project) "pong_vh_wrapper"]} {
		puts "Project pong_vh_wrapper is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists pong_vh_wrapper]} {
		project_open -revision pong_vh_wrapper pong_vh_wrapper
	} else {
		project_new -revision pong_vh_wrapper pong_vh_wrapper
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name VERILOG_FILE ../../pong_vh_wrapper.v
